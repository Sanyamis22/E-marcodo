          ...
          ListHeaderComponent={
            <View style={styles.headerListStyle}>
              <View
                ...
                <CategoryHeading
                  key={0}
                  text='Home / Category 0'
                />
                <ScrollView key={1} horizontal={true} style={{ marginTop: 20 }}>
                  {Array(10).fill(0).map((item, index) => {
                    return <View key={index + 100} style={{ paddingBottom: 10, paddingLeft: 10 }}>
                      <TouchableOpacity><Text style={{ alignItems: 'center', textAlign: 'center', fontWeight: 'bold', color: index === 0 ? 'orange' : 'black' }}>sub{index}</Text></TouchableOpacity>
                    </View>
                  })}
                </ScrollView>
                ...
                <View key={6} style={{
                  ...
                  <View key={0} style={{ flexDirection: 'row', width: 80, height: 40, justifyContent: 'flex-start', alignItems: 'center' }}>
                    <Text style={{ textAlign: 'center', color: 'black', fontSize: 15, fontWeight: 'bold' }}>Filter</Text>
                  </View>
                  <View key={1} style={{ width: 80, height: 40, justifyContent: 'center', alignItems: 'center' }}>
                    <Text style={{ textAlign: 'center', color: 'black', fontSize: 15, fontWeight: 'bold' }}>Sort</Text>
                  </View>
                  <View key={2} style={{ flexDirection: 'row', width: 80, height: 40, justifyContent: 'flex-end', alignItems: 'center' }}>
                    <TouchableOpacity
                      onPress={() => {
                ...
                <ScrollView key={8} horizontal={this.props.gridFlag}>
                  {Array(10).fill(0).map((item, index) => {
                    return <TouchableOpacity key={index + 300} style={{ paddingBottom: 30, paddingLeft: 5 }} onLongPress={() => this.setState({ isModalVisible: true })}>
                      <ProductItem
...
/// //////////////////////////////////////////
export default connect(mapStateToProps, mapDispatchToProps)(CategoryScreens)
/// /////////////////////////////////////////////
