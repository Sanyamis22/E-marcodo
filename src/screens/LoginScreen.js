...
import {signUp, signIn, socialLogin} from '../redux/actions/actions';
        ...
        <View
          ...
          {/* {this.state.selectedTab === '1' ? (
            ...
            <Image
              ...
              resizeMode="contain"
              source={require('../images/light/logo.png')}
            />
          )} */}
          <Image
            style={{
          ...
          <View
            ...
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  borderColor:
                    this.state.selectedTab === '1' ? 'orange' : 'transparent',
                },
              ]}>
              <Text
                style={{
            ...
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  borderColor:
                    this.state.selectedTab === '2' ? 'orange' : 'transparent',
                },
              ]}>
              <Text
                style={{
              ...
              <View style={styles.screenInnerContainer}>
                ...
                <View
                  ...
                  <Image
                    ...
                    source={require('../images/newImages/phone.png')}
                  />
                  <TextInput
                    style={[
                      styles.textInputStyle,
                ...
                <View
                  ...
                  <Image
                    ...
                    source={require('../images/newImages/msg.png')}
                  />
                  <TextInput
                    style={[
                      styles.textInputStyle,
                ...
                <View
                  ...
                  <Image
                    ...
                    source={require('../images/newImages/lock.png')}
                  />
                  <TextInput
                    style={[
                      styles.textInputStyle,
                ...
                <View
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({genderSelect: 'male'});
                    }}
                    style={[
                      styles.tabText2,
                      {
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({genderSelect: 'female'});
                    }}
                    style={[
                      styles.tabText2,
                      // {
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({genderSelect: 'later'});
                    }}
                    style={[
                      styles.tabText2,
                      // {
            ...
            {/* <View style={styles.containerDevi}>
              ...
              <View>
                <Text
                  ...
                  {this.props.language['Or sign in with']}
                </Text>
              </View>
              <View
                style={[
              ...
              <View style={styles.socialLoginRow}>
                {Platform.OS === 'ios' ? (
                  <TouchableOpacity
                    ...
                    <FontAwesome name={'apple'} style={styles.googleIcon} />
                    <Text
                      style={{
                        fontSize: appTextStyle.mediumSize,
                        color: this.props.themeStyle.iconPrimaryColor,
