  ...
  render() {
    return this.state.activityIndicatorTemp ? (
      ...
      <View
        ...
        <Header
          backIcon={
            this.props.navigation.dangerouslyGetParent().state.index >= 0
          }
          menuIcon={
            !(this.props.navigation.dangerouslyGetParent().state.index >= 1)
          }
          cartIcon={true}
          navigation={this.props.navigation}
          name={this.props.language.Category}
          navigation={this.props.navigation}
        />

        {this.props.sortCategory.length === 0 ? (
          <View style={styles.emptyProductView}>
            <View style={styles.emptyProductInnerView}>
              <Icon
                name={'logo-dropbox'}
