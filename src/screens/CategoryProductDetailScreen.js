...
class CategoryProductDetailScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      reviews: [
        {
          avatar: '',
          name: 'Terrence Balfour',
          rate: 0,
          comments: 'AAAAAAAAAAAAAAAAAAAAAA',
        },
        {
          avatar: '',
          name: 'Terrence Balfour',
  ...
  render({categoryProductData} = this.props) {
    console.log('it==>em', this.props.categoryProductData);
    return (
      <View
        style={{
        ...
        <ScrollView style={styles.container}>
          ...
          {/* <Text style={styles.subtitle}>As low as KWD {this.props.price}</Text> */}
          ...
          <View>
            <Text style={[styles.subtitle, {marginBottom: 5, marginTop: 10}]}>
              Size
            </Text>
          ...
          <View style={styles.quantity}>
            <TouchableOpacity
              ...
              onPress={() => this.handleSetQuantity(this.state.quantity - 1)}>
              <Text
                style={[styles.quantityBtnTxt, {fontSize: 120, marginTop: 60}]}>
                -
              </Text>
            </TouchableOpacity>
            <Text style={[styles.quantityText, {marginTop: -5}]}>
              {this.state.quantity}
            </Text>
            <TouchableOpacity
              style={styles.quantityBtn}
              onPress={() => this.handleSetQuantity(this.state.quantity + 1)}>
              <Text style={[styles.quantityBtnTxt, {marginTop: 15}]}>+</Text>
            </TouchableOpacity>
          </View>
          <View
            style={[
          ...
          <ScrollView horizontal={true}>
            {Array(10)
              ...
              .map((item, index) => (
                <View
                  key={index + 100}
                  style={{paddingBottom: 10, paddingLeft: 1}}>
                  <View
                    style={[
                      styles.borderShadow,
                      {
