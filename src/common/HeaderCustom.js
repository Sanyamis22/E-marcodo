...
import { LANG_CODE, getLanguages, SET_LANGUAGE, SET_LANGUAGE_ID, CLEAR_LANGUAGES , GRID_FLAG} from '../redux/actions/actions'
          ...
          <View style={{
            ...
            <View style={{
              ...
              onPress={()=>{
                ...
                const tempitem = this.props.getLanguagesArray.find((data)=> data.code !== this.props.getSelectedlang.code)
              ...
              >
                <Text style={{
                  ...
                  color: appConfigStyle.headerColor
                    ? this.props.themeStyle.textTintColor
                    : this.props.themeStyle.textColor
                }}>{this.props.languageCode== "AR" ? 'KD' :'عربي'}</Text>
              </TouchableOpacity>
              {showGrid &&
                <TouchableOpacity
